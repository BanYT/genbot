...
const quiz = [
  ...
  { q: "How many time zones are there in the world?", a: ["Twenty-four"] },
  { q: "Which European river does flow through six different countries?	", a: ["Donau river"] },
  { q: "What is the capital city of Australia ?	", a: ["Canberra"] },
  { q: "Urticaria is a skin disease otherwise known as what?	", a: ["Hives"] },
  { q: "What kind of animal is the largest living creature on Earth	", a: ["Whale"] },
  { q: "What do dragonflies prefer to eat?", a: ["Mosquitoes"] },
  { q: "What do you get when you crossbreed a donkey and a horse?	", a: ["Hinny"] },
  { q: "Which insects cannot fly, but can jump higher than 30 cm?	", a: ["Fleas"] },
  { q: "In which city is the oldest zoo in the world?	", a: ["Vienna"] },
  { q: "After which animals are the Canary Islands named?	", a: ["Dogs"] },
  { q: "What is the food of penguins?	", a: ["Plankton"] },
  { q: "In which city was the Titanic built?", a: ["Belfast"] },
  { q: "On which island was Napoleon born?	", a: ["Corsica"] },
  { q: "Which building in Athens was destroyed by a Venetian cannon ball in the 17th century?	", a: ["Parthenon"] },
  { q: "Which country sent its navy around the world to fight the Japanese in 1904?	", a: ["Russia"] },
  { q: "What is the name of the network of computers from which the Internet has emerged?	", a: ["Arpanet"] },
  { q: "In what year was Google launched on the web?	", a: ["1998"] },
  { q: "Which unit is an indication for the sound quality of MP3?	", a: ["Kbps"] },
  { q: "In which Nintendo DS game do you have to raise a puppy as well as possible?	", a: ["Nintendogs"] }
];
const options = {
  max: 1,
  time: 50000,
